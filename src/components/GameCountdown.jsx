...
// function GameCountdown({ startTime, onFinish}, ref ) {
...
//         return {
//             reset: () => setCountdown(startTime)
//         }
//     });

//     return (
//         <div className={classes.wrapper}>
//             <div className={classes.timerComponent}><GameTimer className='countdown' /></div>
...
const GameCountdown = forwardRef(({ startTime, onFinish }, ref) => {
    const [countdown, setCountdown] = useState(startTime);
...
GameCountdown.displayName = 'GameCountdown';
