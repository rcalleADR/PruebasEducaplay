        ...
        <div className={classes.background}>
            ...
            <div className={classes.shareWrapper}>
                ...
                <div className={classes.linkWrapper}>
                    <a href="" rel="noopener noreferrer" className={classes.shareLink}>
            ...
            <div className={classes.scoreWrapper} >
                <div className={`${classes.firstScoreLine} ${classes.scoreLine}`}>
                    <span className={classes.scoreTitle}>Puntos</span>
                    <span className={classes.scoreValue}>100</span>
                </div>
                <div className={classes.scoreLine}>
                    <span className={classes.scoreTitle}>Tiempo</span>
                    <span className={classes.scoreValue}>00:34</span>
                </div>
                <div className={classes.scoreLine}>
                    <span className={classes.scoreTitle}>Aciertos</span>
                    <span className={classes.scoreValue}>8 / 8</span>
                </div>
            </div>
            <Button icon={<PlusIcon />} className={classes.reportsButton} onClick={handleClickReports}>
                Resultados
            </Button>
            {showReports && <div className={classes.reports} >
                <div>
